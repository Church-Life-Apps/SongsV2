  ...
  return (
    <View>
      ...
      <Controller
        ...
        rules={{ required: true}}
        render={({field: {onChange, onBlur, value}}) => (
          <TextInputGroup label="Message" inputMode="text" multiline numberOfLines={5} placeholder="" value={value} onChangeText={onChange} onBlur={onBlur} />          
        )}
      />
      <Button variant="green" title="Submit" className="mt-5" onPress={handleSubmit((data) => { onSubmit(data)})} />
    </View>
  );
}